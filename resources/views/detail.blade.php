            ...
            <div class="w-full">
                <div class="h-14 w-full">
                    <div class="w-[100%] flex flex-row justify-between items-start gap-2 ">
                        <button
                            class="px-4 w-[50px] h-12  bg-neutral-200/80 shadow-lg rounded-xl flex items-center  border">
                    ...
                    <div class="flex flex-col gap-3 justify-start mb-[50px]">
                        <div class=" flex flex-col gap-2 mt-5 rounded-lg ">
                            <div class="flex flex-col gap-2">
                                <img class="w-full h-[200px] object-cover rounded-lg shadow-lg" src="/images/daging.png"
                                    alt="">
                                <div class="flex flex-row gap-2 items-start justify-normal">
                                    <img class="w-[60px] h-[60px] object-cover rounded-lg shadow-lg"
                                        src="/images/daging.png" alt="">
                                    <img class="w-[60px] h-[60px] object-cover rounded-lg shadow-lg"
                                        src="/images/daging.png" alt="">
                                </div>
                                ...
                                <div id="price" class="flex flex-row gap-2 items-center justify-normal">
                                    <div class="">
                                        <strong class="text-xl text-primary"> Rp. 100.000</strong>
                                    </div>
                                    <div class="">
                                        <p class="text-sm text-foreground line-through text-text_secondary">Rp. 500.000
                                        </p>
                                    </div>
                                </div>
                                <div id="name" class="flex flex-row gap-2 items-center justify-normal">
                                    <div class="">
                                        <strong class="text-lg text-text_secondary ">Daging Segar Pak Rahmat 500g |
                                            Daging Sapi
                                            Berkualitas</strong>
                                    </div>
                                </div>
                                <div class="w-full justify-between  flex flex-row  items-center">
                                    <div id="name" class="flex flex-row gap-2 items-center justify-normal">
                                        <div id="rating"
                                            class=" rounded border border-primary text-primary flex flex-row items-center justify-normal">
                        ...
                        <div
                            class="card bg-white flex flex-row gap-2 px-2 py-5 mt-1 rounded-lg shadow-lg items-start justify-normal">
                            <img src="/assets/sapi.png" class="w-[60px] h-[60px] rounded-full" alt="">
                            <div class="flex flex-col w-full">
                                <strong class="text-sm font-bold"> Peternakan Pak Pak Rahmat</strong>
                                <div class="flex flex-row w-full justify-between px-2">
                                    ...
                                    <div class="flex flex-col gap-1 items-end text-right justify-normal w-full">
                                        ...
                                        <button
                                            class="text-xs px-2 bg-primary rounded-md py-1 text-white ">Ikuti</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="flex flex-col">
                                <div
                                    class="card bg-white rounded-lg border shadow-md py-5 mt-1 items-start justify-normal flex flex-col">
                                    <div class="flex flex-row gap-2 px-2">
                                        <img src="/assets/sapi.png" class="w-[50px] h-[50px] rounded-full" alt="">
                                        <div class="flex flex-col gap-1">
                                            <strong class="text-sm">Kiyai haji Ans Betty S.</strong>
                                            <div class="flex flex-row gap-1">
                                                <img src="/icons/bintang.svg" class="w-[15px] h-[15px] rounded-full"
                                                    alt="">
                                                <img src="/icons/bintang.svg" class="w-[15px] h-[15px] rounded-full"
                                                    alt="">
                                                <img src="/icons/bintang.svg" class="w-[15px] h-[15px] rounded-full"
                                    ...
                                    <div class="px-2 text-sm mt-2">
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Deleniti, aliquam!
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col">
                                <div
                                    ...
                                    <div class="flex flex-row gap-2 px-2">
                                        <img src="/assets/sapi.png" class="w-[50px] h-[50px] rounded-full" alt="">
                                        <div class="flex flex-col gap-1">
                                            <strong class="text-sm">Haji Ahmad Galuh</strong>
                                            <div class="flex flex-row gap-1">
                                                <img src="/icons/bintang.svg" class="w-[15px] h-[15px] rounded-full"
                                                    alt="">
                                                <img src="/icons/bintang.svg" class="w-[15px] h-[15px] rounded-full"
                ...
                <div class="w-full h-[80px] flex flex-row px-2 py-2 gap-2 fixed bottom-0 left-0 bg-neutral-300">
