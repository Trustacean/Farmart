  ...
  <div class="container mx-auto max-w-xl bg-background h-screen">
    <div class="flex flex-col justify-between pt-16 pb-10 px-8 h-full">
      <div class="">
        ...
        <h2 class="text-3xl font-bold text-text_primary">Daftar Sebagai Penjual</h2>
        <p class="text-md text-text_secondary mt-2">Masukkan nama toko dan pilih alamat toko yang sesuai</p>
      </div>
