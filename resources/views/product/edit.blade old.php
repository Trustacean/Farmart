...
<body class="bg-gray-400">
  <div class="container mx-auto max-w-xl bg-background min-h-screen">
    <div class="p-8 flex flex-col justify-between items-center">
      ...
      <div class="mt-8 flex w-full justify-between items-center mb-4">
        <div class="flex space-x-4">
          <a class="focus:outline-none" href="{{ url()->previous() }}">
      ...
      <div class="p-4">
        <form class="space-y-6">
          <div class="  mb-4">
            <input type="text" id="product_name" name="product_name" value="{{ $product->product_name }}" placeholder="Nama Barang" class="mt-1 block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
          </div>
          <div class="  mb-4">
            <input id="product_description" name="product_description" value="{{ $product->product_description }}" rows="3" cols="50" placeholder="Deskripsi Barang" class="mt-1 block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></input>
          </div>
          <div class="  mb-4">
            <input type="text" id="product_sell_price" name="product_sell_price" value="{{ $product->product_sell_price }}" inputmode="numeric" placeholder="Harga" class="mt-1 block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
          </div>
          <div class="mb-4">
            <input type="text" id="product_weight" name="product_weight" value="{{ $product->product_weight }}" inputmode="numeric" placeholder="Berat Barang" class="mt-1 block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
          </div>
          <div class="mb-4">
            <input type="text" id="product_stok" name="product_stok" value="{{ $product->product_stock }}" inputmode="numeric" placeholder="Stok" class="mt-1 block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
          </div>
          <div class="mb-4">
            <select id="product_category" name="product_category" value="{{ $product->product_category }}" class="mt-1 block w-full px-6 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
