  ...
  <form action="{{ route('product.update', $product->product_id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container mx-auto max-w-xl bg-background h-screen flex flex-col">
      ...
      <div class="p-6 flex flex-col h-full">
        <input required type="text" value="{{ $product->product_name }}" class="w-full h-12 rounded-xl my-2 text-text_secondary text-md px-4 focus:outline-field_border" placeholder="Nama Barang" id="product_name" name="product_name">
        <input required type="text" value="{{ $product->product_description }}" class="w-full h-24 rounded-xl my-2  text-text_secondary text-md px-4 focus:outline-field_border" placeholder="Deskripsi Barang" id="product_description" name="product_description">
        <input required type="number" value="{{ $product->product_sell_price }}" class="w-full h-12 rounded-xl my-2  text-text_secondary text-md px-4 focus:outline-field_border" placeholder="Harga Jual" id="product_sell_price" name="product_sell_price">
        <input required type="number" value="{{ $product->product_weight }}" class="w-full h-12 rounded-xl my-2  text-text_secondary text-md px-4 focus:outline-field_border" placeholder="Berat Barang" id="product_weight" name="product_weight">
        <input required type="number" value="{{ $product->product_stock }}" class="w-full h-12 rounded-xl my-2  text-text_secondary text-md px-4 focus:outline-field_border" placeholder="Stok Barang" id="product_stock" name="product_stock">
