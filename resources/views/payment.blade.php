...
<body class="bg-gray-400">
  ...
  <main class="flex-grow p-4">
    <div class="flex space-x-2 mb-4">
      <button class="bg-primary text-white px-4 py-2 rounded-md ">Pesanan Saya</button>
      <button class="border border-green-500 text_primary px-4 py-2 rounded-md">Pesanan Selesai</button>
    </div>
  ...
  <span class="text-green-500">Diproses</span>
    ...
    <button class="bg-primary text-white px-4 py-2 rounded-md">Telah Dibayar</button>
    </div>
