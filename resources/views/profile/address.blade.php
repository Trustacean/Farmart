...
<body class="bg-gray-400">
  <div class="container mx-auto max-w-xl bg-background h-screen">
    <div class="flex flex-col justify-between pt-16 pb-10 px-8">
      <div class="">
        <a href="../profile" class="text-2xl text-blue-400 my-auto flex flex-row">
        ...
        <h2 class="text-3xl font-bold text-text_primary">Ubah Alamat</h2>
      </div>
      <div class="mt-3 flex flex-col items-center w-full text-center gap-4">
        <div class="w-full">
          <form action="{{ route('profile/address/update') }}" method="POST">
            ...
            <div class="flex flex-col justify-between gap-4">
              ...
              <input required type="text" class="w-full h-12 rounded-xl border border-text_secondary text-text_secondary text-md px-4 focus:outline-field_border" placeholder="Alamat Detail" id="user_address_detail" name="user_address_detail">
            </div>
            <button type="submit" class="mt-8 flex items-center justify-center bg-primary w-full h-12 rounded-xl text-background text-lg">Daftar</button>
          </form>
        </div>
      </div>
    </div>
